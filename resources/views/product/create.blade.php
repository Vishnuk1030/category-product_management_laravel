        ...
        <div class="col-md-4 mx-auto">
            <div class="myform form ">
                <form action="{{ route('product.form') }}" method="post" enctype="multipart/form-data">
                    ...
                    <br>
                    <div class="form-group">
                        <input type="text" name="slug" class="form-control my-input" id="slug"
                            placeholder="Slug">
                        @error('slug')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <br>
                    <div class="form-group">
                        <input type="text" name="description" class="form-control my-input" id="desc"
                    ...
                    <div class="text-center ">
                        <button type="submit" class=" btn btn-block send-button tx-tfm">Create</button>
                    </div>
                    <br>
                    <div class="text-center">
                        <a href="{{ route('product.manage') }}" class="btn btn-info">Manage Product</a>
                    </div>
