...
<body class="theme-color4 light ltr">
    ...
    <div class="container">
        ...
        <table class="table table-striped table-hover table-bordered mt-5">
            ...
            <tbody>
                @foreach ($category_manages as $category)
                    <tr>
                        <th scope="row">{{ $category->id }}</th>
                        <th><img src="{{ $category->image }}" width="100px"></th>
                        <td>{{ $category->name }}</td>
                        <td>{{ $category->slug }}</td>
                        <td>
                            <a href="{{ route('category.edit', encrypt($category->id)) }}"><img
                                    src="{{ asset('assets/images/edit.png') }}" width="20px"></a>
                            <a href="{{ route('category.delete', $category->id) }}"
                                onclick="return confirm('Are you sure want to delete?');"><img
                                    src="{{ asset('assets/images/delete.png') }}" width="20px"></a>
                        </td>
                    </tr>
                @endforeach
