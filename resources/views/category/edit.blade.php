    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            <div class="myform form ">
                <form method="POST" action="{{ route('category.update', $categories->id) }}" id="create-form">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="name">Category Name :</label>
                        <input type="text" value="{{ $categories->name }}" name="name"
                            class="form-control my-input" id="name" placeholder="Category Name">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $categories->slug }}" name="slug"
                            class="form-control my-input" id="slug" placeholder="Slug">
                        @error('slug')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <br>
                    <div class="text-center">
                        <a href="{{ route('category.manage') }}" class="btn btn-danger">Back</a>
                    </div>
